 ...
 */
class GlowCookies { constructor() { this.banner = void 0, this.config = void 0, this.tracking = void 0, this.PreBanner = void 0, this.Cookies = void 0 }
    render() { this.addCss(), this.createDOMElements(), this.checkStatus() }
    addCss() { const e = document.createElement("link");
    ...
    checkStatus() { switch (localStorage.getItem("GlowCookies")) {
            case "1":
                this.openManageCookies(), this.activateTracking(), this.addCustomScript(); break;
            case "0":
                this.openManageCookies(); break;
            default:
                this.openSelector() } }
    ...
    activateTracking() { if (void 0 !== this.tracking.AnalyticsCode && null !== this.tracking.AnalyticsCode) { let e = document.createElement("script");
            e.setAttribute("src", "https://www.googletagmanager.com/gtag/js?id=" + this.tracking.AnalyticsCode), document.head.appendChild(e); let t = document.createElement("script");
            t.text = `window.dataLayer = window.dataLayer || [];\n function gtag(){dataLayer.push(arguments);}\n gtag('js', new Date());\n gtag('config', '${this.tracking.AnalyticsCode}');`, document.head.appendChild(t) } if (void 0 !== this.tracking.FacebookPixelCode && null !== this.tracking.FacebookPixelCode) { let e = document.createElement("script");
            e.text = `\n !function(f,b,e,v,n,t,s)\n {if(f.fbq)return;n=f.fbq=function(){n.callMethod?\n n.callMethod.apply(n,arguments):n.queue.push(arguments)};\n if(!f._fbq)f._fbq=n;n.push=n;n.loaded=!0;n.version='2.0';\n n.queue=[];t=b.createElement(e);t.async=!0;\n t.src=v;s=b.getElementsByTagName(e)[0];\n s.parentNode.insertBefore(t,s)}(window, document,'script',\n 'https://connect.facebook.net/en_US/fbevents.js');\n fbq('init', '${this.tracking.FacebookPixelCode}');\n fbq('track', 'PageView');\n `, document.head.appendChild(e); let t = document.createElement("noscript");
            t.setAttribute("height", "1"), t.setAttribute("width", "1"), t.setAttribute("style", "display:none"), t.setAttribute("src", `https://www.facebook.com/tr?id=${this.tracking.FacebookPixelCode}&ev=PageView&noscript=1`), document.head.appendChild(t) } if (void 0 !== this.tracking.HotjarTrackingCode && null !== this.tracking.HotjarTrackingCode) { let e = document.createElement("script");
            e.text = `\n (function(h,o,t,j,a,r){\n h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};\n h._hjSettings={hjid:${this.tracking.HotjarTrackingCode},hjsv:6};\n a=o.getElementsByTagName('head')[0];\n r=o.createElement('script');r.async=1;\n r.src=t+h._hjSettings.hjid+j+h._hjSettings.hjsv;\n a.appendChild(r);\n })(window,document,'https://static.hotjar.com/c/hotjar-','.js?sv=');\n `, document.head.appendChild(e) } }
    disableTracking() { if (void 0 !== this.tracking.AnalyticsCode && null !== this.tracking.AnalyticsCode) { let e = document.createElement("script");
            e.setAttribute("src", "https://www.googletagmanager.com/gtag/js?id=" + this.tracking.AnalyticsCode), document.head.appendChild(e); let t = document.createElement("script");
            t.text = `window.dataLayer = window.dataLayer || [];\n function gtag(){dataLayer.push(arguments);}\n gtag('js', new Date());\n gtag('config', '${this.tracking.AnalyticsCode}' , {\n 'client_storage': 'none',\n 'anonymize_ip': true\n });`, document.head.appendChild(t) }
        this.clearCookies() }
    clearCookies() { let e = document.cookie.split("; "); for (let t = 0; t < e.length; t++) { let n = window.location.hostname.split("."); for (; n.length > 0;) { let o = encodeURIComponent(e[t].split(";")[0].split("=")[0]) + "=; expires=Thu, 01-Jan-1970 00:00:01 GMT; domain=" + n.join(".") + " ;path=",
                    i = location.pathname.split("/"); for (document.cookie = o + "/"; i.length > 0;) document.cookie = o + i.join("/"), i.pop();
                n.shift() } } }
    addCustomScript() { if (void 0 !== this.tracking.customScript) { let e;
