...
class GlowCookies { constructor() { this.banner = void 0, this.config = void 0, this.tracking = void 0, this.PreBanner = void 0, this.Cookies = void 0 }
    ...
    addCustomScript() { if (void 0 !== this.tracking.customScript) { let e;
            this.tracking.customScript.forEach((t => { "src" === t.type ? (e = document.createElement("script"), e.setAttribute("src", t.content)) : "custom" === t.type && (e = document.createElement("script"), e.text = t.content), "head" === t.position ? document.head.appendChild(e) : document.body.appendChild(e) })) } }
